        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="flex gap-3">
                {footerData.brand.socials.map((socail, i)=>(
                  <a key={i} href={socail.link} className="size-9 rounded-lg bg-white/10 flex-center hover:bg-white/2"><socail.icon className="size-4"/></a>
                ))}
              </div>
              </div>
