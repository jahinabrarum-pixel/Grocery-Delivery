    ...
    return (
      <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
          ...
          <p className="text-sm font-semibold text-app-text-light mb-4">
          ...
          {steps.map((s, i) => (
            <div key={s.key} className="flex items-center gap-2">
              <button
                ...
                className={`flex items-center gap-2 px-7 py-2 rounded-xl text-sm font-medium transition-colors ${
                  step === s.key
