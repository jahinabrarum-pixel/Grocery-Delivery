  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <button
          onClick={() => navigate(-1)}
          className="mb-6m flex items-center gap-1.5 text-sm text-app-text-light hover:text-app-green transition-colors"
        >
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border-app-green" : "bg-app-orange text-white hover:bg-app-orange-dark"}`}
                >
