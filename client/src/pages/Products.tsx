          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  <select value={sort} onChange={(e)=>updateFilter("sort", e.target.value)} className="appearance-none pl-3 pr-3 py-2 text-sm bg-white rounded-xl border border-app-border focus:border-app-green outline-none cursor-pointer">
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                className="px-5 py-2 text-sm font-semibold bg-app-green text-white rounded-xl hover:bg-app-green-light transition-colors">Clear Filters</button>
              </div>
            ) : (
